...
static const char *const yytname[] =
{
  ...
  "MINUS", "TIMES", "DIVIDE", "EOL", "$accept", "statements", "statement",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* statement: expression EOL  */
#line 19 "calc.y"
                                            { printf("= %d\n", yyvsp[-1]); }
